...
const MisPublicaciones = () => {
    ...
    const obtenerPublicaciones = async () => {
        try {
            const response = await axios.get("https://viveoutdoors.onrender.com/publicaciones");
    ...
    const handleEstadoClick = async (id, nuevoEstado) => {
        try {
            const ruta =
                nuevoEstado === "Activo"
                    ? `https://viveoutdoors.onrender.com/publicacionactiva/${id}`
                    : `https://viveoutdoors.onrender.com/publicacioninactiva/${id}`;
